...
= 1.5.5 =
* remove PluginUpdateChecker now that we're Must-Use (was blocking other omega plugins from showing in Updates anyways)
...
= 1.3.4 =
* new filtering buttons to show only selected params (can be combined with sort)
* show current number of sites visible (according to filtering rules)

= 1.3.3 =
* show Archive toggle status on site tiles and column lists
...
* show Local DEV when site has option enabled
...
= 1.2.3 =
* show database blog ID # when hover over site icon
* show client ID in meta
...
= 1.1 =
* My Sites tiles display logo, export times, buttons
* sites are listed in alphabetical order now
